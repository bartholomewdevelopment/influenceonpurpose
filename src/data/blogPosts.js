...
const blogPosts = [
  {
    ...
    image: blogarrow2,
    content: `
      <p>Do you have a high turnover rate?</p>

      <p>Ah, the Great Resignation. We’ve read the headlines screaming all year about the masses of employees turning in their notice (or just disappearing) in search of greener pastures or to escape poor working conditions.</p>

      <p>The costs of turnover are high: recruiting, screening, training, etc. And the longer an employee has been with you, the higher the costs of replacing that knowledge and experience. One of the questions we’re asked as coaches is how to help employers reduce their turnover.</p>

      <p>But before you can jump in and start talking about reducing turnover, you first have to figure out what kind of turnover you have.</p>

      <h3>Involuntary Turnover</h3>
      <p>There are different types of turnover: the first is involuntary turnover. This is where the employer terminated the employment for a variety of reasons: restructuring of the company, bad fit, poor performance, etc. Usually, when turnover is considered a problem, this isn’t the type of turnover we’re talking about.</p>

      <h3>Voluntary Turnover</h3>
      <p>Voluntary turnover is what happens when an employee chooses to leave, and this is what leaders are usually looking to avoid. But even with voluntary turnover, there are different reasons people choose to leave.</p>

      <h4>Functional Turnover</h4>
      <p>The first reason is something that is out of the employer’s power to influence. Perhaps the person is relocating for family reasons, for medical care or to be closer to an aging relative, or because of a spouse or partner’s career opportunity in another place. It can even be that this position just isn’t a good fit for that person. No one is at fault here, it just happens. Cover your bases by conducting a thorough exit interview, then offer any practical assistance you can with their transition and wish them well in their future endeavors.</p>

      <p>The next type of turnover is what we like to call Flow-through Turnover. This is when an employee just outgrows the position they were hired for, which is the case with many entry-level jobs. These types of low-skilled, low-wage jobs are a necessary part of the economy and an individual’s personal career growth. They help people gain experience, develop skills, and pay for schooling or training. Then, when the time is right for them, they can move on to something better, thanks to this initial employment that benefited the company and the individual. This can cover internal promotions and transfers, or the college kid working for minimum wage while they earn their degree.</p>

      <p>Unlike other types of turnover, Flow-through Turnover can be a result of good leadership and an indicator of a healthy culture. It’s a sign that people are being given the opportunity to grow and develop, rather than being held back to fit the needs of the employer. It’s a sign of a regenerative culture, where growth not only occurs but is encouraged and systems are set up to foster that growth, in the people and the culture. And, unlike some types of turnover, it’s not a sign of a dying culture or poor leadership, it's nobody's fault, and it’s nothing that needs fixing. It’s just the nature of some types of employment. Again, treat them well and wish them luck.</p>

      <h4>Dysfunctional Turnover</h4>
      <p>Now we get to the third type of voluntary turnover: Dysfunctional Turnover. This is when good employees and high performers choose to leave their job because of a problem, not as a natural step in their career path. The key here is that they are leaving somewhere, not just going somewhere. This is a sign of an unhealthy work culture; too much of this turnover and it’s the sign of a dying culture. This is the cost of poor leadership.</p>

      <p>At a workshop with a small business, we asked the employees why they left their previous employment. Nearly all of the answers fit into the “unhealthy culture” category: poor work environment, poor treatment, they felt no one listened to them or cared about them. Ironically, no one once mentioned poor pay or benefits. The same was true when we asked what they liked about their current work. Answers included: feeling heard, feeling like the owners cared about them, liking the work environment. Again, no mention of pay.</p>

      <p>That isn’t to say pay and benefits aren’t important, because they are, but people don’t leave a place that pays market rates if there isn’t something else going on. This is the sign of a degenerative culture, a business that is built on mining its employees and stakeholders, rather than building them up to create a self-sustaining, self-healing culture.</p>

      <p>Find out what is driving your involuntary turnover. More often than not, you will find the driver is poor leadership, which leads to an unhealthy or dying culture. This can even happen within a company, when employees are transferring away from a certain section or team at higher rates than other sections. It is poor leadership that is creating a degenerative culture, which in turn drives away the very people needed to make the business successful.</p>

      <p>And the sad part is, most people don’t set out to be poor leaders. Usually, it’s someone trying their best but with no idea of what they are doing wrong or how to fix it if they do know. They are stressed, perhaps moving from crisis to crisis, unprepared or underprepared to help build the kind of team and culture they would really like to lead, or to be the leaders they really want to be. Are you investing in developing your leaders? Are you intentionally creating a culture where people feel heard and valued? Where they feel they are a contributing, vital member of a team, whatever role they fill?</p>

      <p>Because when it comes to curing Dysfunctional Turnover, the best remedy isn’t more money or a better benefits package. It’s good leadership. Good leadership is good business.</p>
    `,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    image: weakness,
    content: `
      <p>As I work with leadership coaching clients, one of the early steps in the process is evaluating the current effect of their influence on their stakeholders. One powerful way of doing this is through 360 surveys or collecting feedback from those who are impacted by the leader. While debriefing the survey report with the client, I’ve noticed an unintended problem caused by our current “gentle” language.</p>

      <p>In our professional language, there has been a focus on eliminating the word “weakness” as we evaluate performance. We use words like “development opportunity” instead to avoid hurting someone’s feelings or causing defensiveness. Certainly, it is wise to be respectful of others. There is nothing amiss with showing respect and avoiding creating defensiveness. Respect contributes to strong working relationships. Additionally, people can’t address opportunities for improvement when they become blinded because of defensiveness.</p>

      <p>Though the purpose is good, the strategy is seriously flawed. When we simply replace words that create sensitivity, the very emotions we are trying to avoid are simply transferred to the new word. In effect this will damage our credibility. If you want to destroy the meaning of the words “development opportunity,” use them every time you want to talk about someone’s weaknesses. The outcome of that practice is very predictable. My advice is to call a strength a strength and a weakness a weakness.</p>

      <p>The preliminary problem with this practice comes by failing to focus on the most powerful opportunities you have to improve as a leader. In other words, your most important development opportunities are usually realized by building on your strengths. If all you do is focus on your weaknesses, the best you’ll ever be is average. There is no shortage of evidence indicating the importance of building on strengths. It’s always a shame to see people deny themselves impactful personal growth because they don’t have a constructive way to deal with weaknesses and fail to build on their strengths.</p>

      <p>In pointing out the importance of building on strengths, I’m not saying anything new. The point I am making is to not focus exclusively on strengths and ignore weaknesses. Weaknesses should be recognized and addressed effectively. After acknowledging you have weaknesses, it is useful to identify what type of weakness it is and what effect it has on your outcomes.</p>

      <p>For the purpose of improving leadership influence, I have identified four types of weaknesses:</p>

      <p>The first type I mention is a weakness that has no effect on your desired outcomes. An example (in my case), is my complete lack of competence as a neurosurgeon. Under no circumstance should I ever operate on someone’s brain. I’m okay with that. Brain surgery has nothing to do with the essential functions of any of my roles in life.</p>

      <p>Though the example above is extreme, it illustrates the point. You may have many weaknesses that have no effect on the expectations your stakeholders have of you or your personal goals. When you become aware of a weakness, evaluate the effect this has on your desired outcomes. You may find this weakness is not worth your attention.</p>

      <p>The next type of weakness is as much the organization’s opportunity as the individual’s. It requires understanding your strengths and weaknesses as well as the strengths and weaknesses of those around you. Simply put, you’re just not good at everything. You may be strong in operations and rely on others to make the sale… or vice-versa.</p>

      <p>Awareness of this weakness may identify opportunities for collaboration. Awareness of your strengths and weaknesses as well as your colleagues' can help you see how you can use complementary strengths to accomplish shared goals. This is the essence of team work.</p>

      <p>The third type of weakness is directly related to your ability to do what is expected of you. These are weaknesses in the classic sense which affect current performance or keep you from progressing as you would like. This type of weakness can be addressed by receiving training to overcome a gap in skill or coaching to develop more effective influence strategies. Unfortunately, this is the area we most often address with euphemisms such as “it’s not a weakness, it’s a development opportunity.” This can cause a lack of urgency in making needed improvements. When this becomes a pattern, you will have a culture of failure rather than a culture of accountability.</p>

      <p>The fourth type may not be seen as frequently but it is critical to address. These are the weaknesses we call fatal flaws or derailers. They are caused by behaviors that affect people’s ability to trust you. These include perceptions of honesty, capability or reliability. This happens when people feel someone is deliberately misleading, does not keep commitments or is incapable of performing the essential functions of their work. Of all the weaknesses to address, this area is the most likely to cause defensiveness. This area is also most likely to cause others to deal with the person who has the fatal flaw with extreme measures ranging from total avoidance to verbal attacks. Certainly, finding a way to talk about this openly and deal with it is critical to any success.</p>

      <p>With any weakness, being able to acknowledge they exist and identifying what type they are can lead to effective strategies for improvement. Both weaknesses and strengths are development opportunities if they are addressed with the respect required to avoid defensiveness and the honesty required to impact needed change.</p>

      <p>The principle behind all of this is: growth or progress can only come after you see the gap between what you need to succeed and what you are doing now. Defensiveness comes from a lack of humility. Any lack of humility will blind you to the truth. The truth really can set you free.</p>
    `,
  },
  {
    id: 4,
    ...
    image: mission,
    content: `
      <p>First, let’s establish a mutual understanding of terms. People often find themselves in a conversation, debating what they think are different sides of an issue, only to realize they agree in principle and are arguing terminology. Below is an understanding of common terms that don’t always have common meaning:</p>

      <p>Values – The basic principle-centered ideals from which an individual measures the worth of actions, interactions, and outcomes. Examples: loyalty, honesty, fidelity, compassion, etc.</p>

      <p>Vision – What a person sees as a desired reality to come. What one wants to be or become as an individual or an organization. Examples: “I would like to be wise and kind”. Or, “Our Company will be a place where people enjoy their work and others value the work we do.”</p>

      <p>Mission – What will it take to accomplish the vision? What do we all want to accomplish? How will we meet the needs and expectations of our stakeholders? Examples: “I will facilitate the success of others.” Or, “We will provide quality responsible services, which will provide security and fulfillment to employees; win/win partnerships with our vendors; profitable return on investment for owners; and positive contribution to our community.”</p>

      <p>Plan – The strategic plan developed and written to accomplish specific stakeholder outcomes</p>

      <p>Practices – Systems implemented and actions taken to follow through on the plan</p>

      <h3>What a Mission Statement is Not</h3>
      <p>A mission statement is not a few magic words that inspire the otherwise confused masses to greatness. Nor is it orders from the boss to tell employees what’s really important around here.</p>

      <p>No, there is nothing intrinsically magical about a mission statement. A mission statement in which employees have no ownership or put no value is more likely to motivate negatively than positively. One of the major benefits of mission statements also happens to be what creates great risk. A mission statement serves to help judge the integrity of actions and decisions with the stated values of the company. Therefore, if actions or decisions are consistently considered to not be in line with stated values, the integrity of the actor(s) or decision maker(s) is suspect, maybe even ridiculed. After all, nobody likes a hypocrite.</p>

      <p>Though no one intends to act in ways that encourage others to label them harshly, negative conclusions do commonly occur when others can’t see the connection between what is said and done. It’s that if-I-don’t-know-I’ll-make-it-up thing. When we do make it up, for some reason it’s seldom pretty. In other words, if we’re not walking the talk, what we say will come back to hurt us.</p>

      <p>Understanding even some of the risk, why would anyone ever want to invest time and money in developing a mission statement?</p>

      <h3>What a Mission Statement Is</h3>
      <p>A mission statement reflects a deep understanding of mutual purpose, giving all actions taken on behalf of the company united value and direction. It can serve as a gauge – even a lodestar – by which the value of actions and decisions can be measured. To each individual, a mission statement can provide a sense of personal direction and orientation within the company. “I get the big picture and know how I can contribute.”</p>

      <p>According to Stephen Covey, trust is the highest form of human motivation. Though most of us readily acknowledge the value of a high-trust environment, we often feel the negative results of violated trust and don’t even know how we got there. For many of us, trust is either there or it isn’t. What value, then, would we put on being able to deliberately create the conditions of trust?</p>

      <p>The ability to identify or create mutual purpose is essential in establishing conditions of trust. If I know that you want what I want, I don’t have to worry about manipulation or hidden agendas. A mission statement that is well conceived, written, communicated and integrated into the company’s culture can provide the basis of trust to help an organization move forward. Of course, that’s only the beginning. Good leadership and management require using this focal point to measure the worth of ongoing behaviors and doing so in a way that is motivating and logical.</p>

      <p>In the development of a mission statement, process is more important than product. Experience has taught that involvement is a major factor in commitment. If you want employees to be committed to the interests of the company, they need to be significantly involved in the process. “I am more willing to commit to ‘our’ cause than ‘your’ cause.”</p>

      <p>An effective mission statement acknowledges consideration of all of the stakeholders of the company. If we truly believe “the customer is always right,” we may soon find we are unable to meet customer demands. Without the commitment of investors, employees, vendors, and the community, we will find the resources required to meet our obligations are lacking or not there at all. Likewise, focusing only on any one of the stakeholders and/or neglecting any of the other stakeholders exposes an Achilles heel. This vulnerability can often prove to be an unexpected setback or downfall just when we’re moving full speed ahead and we think the world is our oyster. With this in mind, a balanced mission can create a solid foundation upon which lasting success can be built. Having clearly identified and articulated the needs of each stakeholder group provides the basis for a relevant strategic plan. This same sense of mission will allow the organization to measure the success of that plan.</p>

      <p>In the final analysis, it comes down to what we want and what we’re willing to do about it. Developing a mission statement isn’t a quick and easy process; not if we want to do it right. If done poorly or we’re not willing to commit to it, it may even do more harm than good. And yet, if we want to be a great company and not just good, the process of developing a mission statement can be an essential contribution to a company of qualified, committed people working together to accomplish mutual purpose.</p>
    `,
  },
  {
    id: 5,
  ...
  },
  {
    ...
    image: leadership,
    content: `
      <p>Many leaders are faced with the challenge of taking their organizations to another level.</p>

      <p>This transition comes in many forms, such as an entrepreneur who has successfully taken the company to a point that will require a team of leaders to continue the progress; a family business that has been around for years that must hand it off to the next generation; or a company that exists successfully in its market and sees opportunity in a larger or expanded market.</p>

      <p>This is where organizations often hit a wall. The problem, as with individual career development, is the behaviors that created success at one level all but guarantee failure at the next.</p>

      <p>For example, as entrepreneurs drive their business to success, they should turn a blind eye and deaf ear to all those who say it cannot be done. They must be aware of all the obstacles facing the fledgling organization and overcome them, often through sheer determination.</p>

      <p>As the organizations grow, however, their capacity is reached and they become the bottleneck. The tactics that bring an organization to life become the behaviors that stunt their growth.</p>

      <h3>Responsibility Turnover</h3>
      <p>Entrepreneurs must transition from the hero leading the charge and creating a successful start-up through sheer will and determination to steward leaders whose influence strengthens a management team and creates scalable alignment with the mission.</p>

      <p>It is critical to identify this behavioral change as an emotional process more than a cognitive one. People don’t do what they do because of what they know, they do it because of how they feel. How many times do parents ask their children, “Why did you do that – you know better?” That’s the wrong question. Seeking to understand feelings would be more fruitful.</p>

      <p>Likewise, it is no wonder entrepreneurs, who have invested their energy and identity to bringing organizations to life, have trouble turning the company over to someone else. Contrasting perspectives are seen emotionally as the enemy to progress and a personal affront. An entrepreneur struggles to distinguish the feedback of pessimistic naysayers from those who could be trusted advisors. The habit of going full speed ahead without considering the risks that were required in the organization’s infancy ceases to be a necessary survival technique and becomes destructive.</p>

      <p>When this happens, the introspection required to improve leadership and results lies outside the realm of consideration. The leader is often seen as ego-centric, with self-awareness viewed as the missing characteristic. Therefore, entrepreneurs are not aware of their full effect on their organizations.</p>

      <p>Research and experience show the twin characteristics of great leadership to be humility and strength of will. In a culture where humility is interpreted as weakness, it is a characteristic that proves to be a prerequisite for influential yet invisible leadership. Humility alerts entrepreneurs to habits that restrict empowerment of the next generation of leaders and helps overcome them.</p>

      <h3>Overcoming Personality</h3>
      <p>Because this transition is so difficult, many think it’s impossible. The very term entrepreneur creates an insurmountable obstacle. It’s often believed by labeling a personality type, one can categorize and predict behavior. If you want to avoid change and excuse your behavior, identify your personality type and say, “That’s just the way I am.”</p>

      <p>To overcome the behavioral obstacles to leading at the next level, you have to identify what you really want and do what it takes to get there. The key to change won’t be found in the deterministic thinking of personality typing. You can begin the journey by identifying a compelling value proposition.</p>

      <p>The process of leading through critical transitions lies in three overarching components:</p>

      <p>First, identify a compelling vision for your future role. This will be something worth working for. It will bring personal fulfillment and be aligned with the ongoing needs of the organization.</p>

      <p>Second, create an organizational structure starting with the leadership team you trust. This does not mean cloning yourself. This would only serve to increase overhead without embracing the diversity of thought or skill required for the larger organization.</p>

      <p>The third and most difficult step is to change habits. This is where the combination of humility and strength will be required in large doses.</p>

      <p>With a compelling vision, the right team of leaders, a solid game plan and good coaching, the entrepreneur can learn to become a leader of greater influence while unlocking the potential of the organization.</p>
    `,
  },
  {
    id: 7,
    ...
    image: trap,
    content: `
      <p>Many of us have had the experience of an employee or coworker entering our office and asking “Can I talk to you?” Often the next request is for an assurance of confidentiality. Though this seems like a simple and common interaction, what comes next has caused a dilemma for people at all levels of organizations. I have seen CEOs and front-line employees alike struggle to get out of this predicament. How you handle this situation will either enhance your credibility or damage it.</p>
  
      <p>You can agree to give audience to your colleague and assure confidentiality. In doing so you not only show support to an employee facing a challenge, you validate your open-door policy. After all, open dialogue provides valuable information and directly affects the quality of decision making. Better decision making directly affects the quality of outcomes. Or so it would seem…</p>
  
      <p>Complications occur when you receive information that you feel needs to be dealt with in a more open forum in order to solve a problem or avoid negative consequences. Keeping this information confidential may prove awkward if it involves others who trust you. For example, you find yourself in a situation where another colleague believes he is in an open honest conversation with you. Yet, you are holding back information that is important to this person. In essence you’ve allowed someone to place a burden on you that you feel honor-bound to carry and helpless to solve. If keeping what you’ve learned confidential creates sufficient risk, you may actually break your promise and share the information in order to alleviate the danger; a classic no-win situation.</p>
  
      <p>On the other hand, you can tell the person you will not hear their concerns or will not promise confidentiality. Refusing to listen may keep you from being burdened by another’s problem. You are still likely, however, to be affected by the problem you’ve chosen not to hear. You’ve also failed to connect with a coworker when collaboration is a key to organizational success. You can assent to listen, but looking ahead, say that you cannot assure confidentiality. In this case, your petitioner is unlikely to feel safe and will not know how to proceed.</p>
  
      <p>In this situation, as with many others, what can become a violation of trust is caused by unclear purpose and the absence of simple ground rules.</p>
  
      <p>Before you provide an answer, you need to increase your own understanding of this person’s request and intentions. Knowing the expectations will allow you to respond in a way that meets the needs of your associate. Adding a clear understanding of your own role and your responsibilities to the overall mission will allow you to act with confidence and integrity. You have the opportunity to provide assistance to a fellow employee and contribute to the success of the organization you serve.</p>
  
      <p>You can fit your assistance to the expectations of your associate by asking two questions and establishing one basic ground rule.</p>
  
      <p>1) Is he looking for a sounding board? or...</p>
  
      <p>2) Is he expecting your help to solve a problem?</p>
  
      <p>You can maintain a higher level of trust with your company and others by agreeing to a simple ground rule:</p>
  
      <p>“If the information you are about to share puts our company or others at risk, I will not be able to assure confidentiality.”</p>
  
      <p>Is he looking for a sounding board to let off steam or process his thoughts? If he needs a sounding board, you can provide a listening ear and possibly some feedback that helps him to deal with the problem he is facing. In this case, the concern may not require a specific solution, only to be more clearly understood or seen from a different perspective. If a significant problem remains, you may need to brainstorm solutions to help him feel prepared to confront the issue.</p>
  
      <p>He may find the second question applies to his concern. Does he have an expectation that with your assistance the circumstances causing concern will be changed? If he says he is asking for help to solve a problem, you should inform him that others may need to be involved in order to get the outcome he is looking for. In this case help him to create a plan of action. Then identify who those others should be and include them in the problem-solving process.</p>
  
      <p>Before any discussion occurs, make certain you have agreement on the ground rule. This assures your colleague that you not only have his best interest in mind, you also bear a responsibility to other stakeholders. In almost all cases this condition is understood and accepted. In the rare case when it is not, your associate can choose not to share information before you are put in a position to violate his trust or fail to live up to your stewardship in the organization.</p>
  
      <p>Should this condition cause him to decide not to continue with the conversation, you may want to advise him to seek help from HR or even an EAP.</p>
  
      <p>Finally, it is important to remember your own role. There should be no expectation that you serve as therapist, counselor, or clergy. In this case, you are in a professional setting. You are not bound by regulations, license, or oath: all you have is your word. As I stated in the opening paragraph, your choice will enhance your credibility or damage it. If you establish clarity of purpose and consider the needs of all of your stakeholders, you will be able to bring value to a colleague seeking assistance as well as the organization you serve.</p>
    `,
  },
];
