        ...
        <nav className="navbar navbar-expand-lg bg-light-green rounded-navbar">
          ...
          <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <Link className="nav-link text-white" to="/what-we-do">What We Do</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link text-white" to="/who-we-are">Who We Are</Link>
              </li>
              {/* Dropdown for More */}
              <li className="nav-item dropdown">
                <a className="nav-link dropdown-toggle text-white" href="#" id="moreDropdown" role="button" data-bs-toggle="dropdown">
                  More
                </a>
